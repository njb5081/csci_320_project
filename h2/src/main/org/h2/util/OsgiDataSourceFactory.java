...
public class OsgiDataSourceFactory implements DataSourceFactory {
     ...
     * @throws java.sql.SQLException if unsupported properties are supplied, or if data
     ...
     * @throws java.sql.SQLException if any property is supplied.
     * @return a driver.
     */
    @Override
     ...
     * @throws java.sql.SQLFeatureNotSupportedException if unsupported properties are
     *             present
     */
