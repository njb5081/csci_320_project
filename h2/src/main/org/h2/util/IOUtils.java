...
public class IOUtils {
     ...
     * @throws java.io.EOFException if the end of file has been reached before all bytes
     *             could be skipped
     * @throws java.io.IOException if an IO exception occurred while skipping
     */
     ...
     * @throws java.io.EOFException if the end of file has been reached before all
