...
public final class JoinBatch {
    ...
    private static final class JoinRow {
         ...
         * for this row</li>
         * <li>{@link java.util.concurrent.Future}: means that we need to get a new {@link Cursor}
         * from the {@link java.util.concurrent.Future}</li>
         ...
         * 1. Slot contains {@link java.util.concurrent.Future} ({@link #S_FUTURE}).
         * 2. Slot contains {@link Cursor} ({@link #S_CURSOR}).
         * 3. Slot contains {@link Row} ({@link #S_ROW}).
         *
         * @param joinFilterId {@link org.h2.table.JoinBatch.JoinRow} filter id.
