...
public class JdbcConnection extends TraceObject implements Connection,
     ...
     * @return the statement
     * @throws java.sql.SQLException if the connection is closed or the result set type,
     ...
     * @throws java.sql.SQLException if the connection is closed or the isolation level
     *             is not supported
     */
    @Override
