...
public class JdbcResultSet extends TraceObject implements ResultSet, JdbcResultSetBackwardsCompat {
     ...
     * @throws java.sql.SQLException if the column is not found or if the result set is
     *             closed
     */
    @Override
     ...
     *
     * @param columnIndex (1,2,...)
     * @throws java.sql.SQLException if the result set is closed or not updatable
     */
    @Override
     ...
     * @param columnLabel the column label
     * @param x the value
     * @throws java.sql.SQLException if result set is closed or not updatable
     */
    @Override
     ...
     * @param columnLabel the column label
     * @param x the value
     * @throws java.sql.SQLException if the result set is closed
     */
    @Override
     ...
     * @throws java.sql.SQLException Unsupported Feature if the method is called for a
     ...
     * remembered.
     *
     * @throws java.sql.SQLException if the result set is closed or is not updatable
     */
    @Override
     ...
     *
     * @throws java.sql.SQLException if the result set is closed or if not on the insert
     ...
     *
     * @throws java.sql.SQLException if the result set is closed, if the current row is
     ...
     *
     * @throws java.sql.SQLException if the result set is closed or if the current row is
     ...
     * @throws java.sql.SQLException if the connection is closed
     */
    @Override
